...
<div id="info">
	...
	by our strict versioning rules. Alpha here doesn't actually refer to the quality but how 
	nobody has bothered releasing v1.0 (ie. documentation for various features is not present in 
	full, etc). By common versioning this would be known as a "perpetual beta" state. Still, some 
	caution is advised when using Mjölnir in it's current state with out some knowledge of it's 
	internals.</p>
