...
<p>
	You can use the <code>bin/order</code> command line utility for most tasks. It is highly recommended
...
<hr/>
<p>More docs are available at the <code><?= DOCROOT.'+App'.DIRECTORY_SEPARATOR.'help'.DIRECTORY_SEPARATOR ?></code> directory</p>